      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white text-center">Our Home</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white text-center">Garden</h3>
            <p className="mt-2 text-base text-gray-500 dark:text-gray-300 text-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white text-center">History</h3>
            <p className="mt-2 text-base text-gray-500 dark:text-gray-300 text-center">
